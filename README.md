...
node.js backend app + fronted app + mongoDB


In this project you can find 2 folders: the docker containers folders with the dockerfile and the services. 
and the Helm folder containes the helm charts
